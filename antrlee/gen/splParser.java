...
public class splParser extends Parser {
	...
	public static final int
		...
		RC=29, INT=30, ID=31, FLOAT=32, CHAR=33, CHATTOKEN=34, INVALID_CHAR=35, 
		LINE_COMMENT=36, BLOCK_COMMENT=37, WS=38, INVALID_ID=39, INVALID_EXP=40;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"INT", "ID", "FLOAT", "CHAR", "CHATTOKEN", "INVALID_CHAR", "LINE_COMMENT", 
